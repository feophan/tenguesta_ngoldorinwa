---
title: Piedmontese System of Vowels
---
import Aside from '../../../../components/newAside.astro';
import Icon from '../../../../components/svg.astro';

<Aside type="quote" title="AppE (I)">the sounds … were of normal kind … approximately those represented by *i, e, a, o, u* in English *machine, were, father, for, brute*, irrespective of quantity.</Aside>
